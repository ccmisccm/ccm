...
from TransCGAN_model_2D_constast import *
from cgan_functions_2D_constast import train, save_samples, LinearLrDecay, load_params, copy_params, cur_stages
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    # import network
    gen_net = Generator(latent_dim=90, seq_len=100, data_embed_dim=69, channels=1)

    print(gen_net)
    dis_net = Discriminator(channels=1, data_embed_dim=69, seq_len=100)
    print(dis_net)
...
def gen_plot(gen_net, epoch):
    ...
    for i in range(10):
        fake_noise = torch.FloatTensor(np.random.normal(0, 1, (32, 69,90)))
        fake_label = torch.randint(0, 5, (32,))
