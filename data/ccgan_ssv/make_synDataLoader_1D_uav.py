...
from TransCGAN_model_1D_uav import *
from DataLoader_1D_uav import mitbih_train
...
class syn_mitbih(Dataset):
    def __init__(self, n_samples = 2000, seq_len = 69, reshape = False, model_path=r'D:\Users\Administrator\Desktop\Semi-Marc-SimSiam-main\Semi-Marc-SimSiam-main\data\ccgan_ssv\logs\1D_ccgan_2025_03_26_16_50_48\Model\checkpoint'):
...
class mixed_mitbih(Dataset):
    def __init__(self, real_samples = 200, syn_samples = 300):
        syn_ecg = syn_mitbih(n_samples=syn_samples, reshape=True)
        syn_ecg.data = np.squeeze(syn_ecg.data, axis=2)
