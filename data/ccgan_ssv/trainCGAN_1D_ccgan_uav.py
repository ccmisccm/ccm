...
import cfg
from DataLoader_1D_uav import *
from TransCGAN_model_1D_uav import *
from cgan_functions_1D_uav import train, save_samples, LinearLrDecay, load_params, copy_params, cur_stages
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    print(gen_net)
    dis_net = Discriminator(in_channels=1, patch_size=1, data_emb_size=100, label_emb_size=10, seq_length = 69, depth=3, n_classes=7)
    print(dis_net)
...
def gen_plot(gen_net, epoch):
    ...
    for i in range(10):
        fake_noise = torch.FloatTensor(np.random.normal(0, 1, (32, 100)))
