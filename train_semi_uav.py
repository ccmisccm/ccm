...
from models import costumed_model_uav
import math
import random
...
半监督学习的训练过程，冻结部分参数层
"""
def train_semi(model, tr_dataset, val_dataset, args,ssv_method,aug_method,loop_flag=False):
    ...
    if loop_flag==True:
        val_acc, _= check_accuracy_final(model, val_loader, device,ssv_method,aug_method,error_analysis=True,filename="semi")
    else:
